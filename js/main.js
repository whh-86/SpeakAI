(function (window, $) {
	...
	function collapseSidebar() {
        $('#sidebar-col').addClass('collapsed-sidebar');
        $('#main-col').addClass('expanded-main');
    }

    function expandSidebar() {
        $('#sidebar-col').removeClass('collapsed-sidebar');
        $('#main-col').removeClass('expanded-main');
    }

    $('a#prevslide').click(function(){
        if (!$('#sidebar-col').hasClass('collapsed-sidebar')) {
            collapseSidebar();
        }
        return false;
    });
